  ...
  * @version $Id: OWNet.java,v 1.9 2012/12/24 11:28:37 gzoug Exp $
  *
...
//
     ...
     */
    private String OW_Read(String path, int expectedDataLen) throws IOException, OWException
    {
        String retVal = "";
        int[] msg = null;
        ...
        if (msg[OWNET_PROT_RETVALUE] >= 0) {
          ...
          disconnect(false);
          throw new OWException("Error reading from server.", path, msg[OWNET_PROT_RETVALUE]);
        }
     ...
     * @return attribute's value
     */
    private String OW_Read(String path) throws IOException, OWException
    {
     ...
     * @throws java.io.IOException Exception to throw, when something is wrong
     */
    private boolean OW_Write(String path, String value) throws IOException, OWException
    {
        ...
        if (msg[OWNET_PROT_RETVALUE] >= 0) {
            ...
            disconnect(false);
            throw new OWException("Error writing to server.", path, msg[OWNET_PROT_RETVALUE]);
        }
     ...
     * @return presence
     */
    private boolean OW_Presence(String path) throws IOException, OWException
    {
        boolean retVal = false;
        int[] msg = null;
        ...
        msg = getPacket();
        if (msg[OWNET_PROT_RETVALUE] >= 0 ) {
        	// no data expected, but need to read payload 
        	if (msg[OWNET_PROT_PAYLOAD]>=0) 
        		getPacketData(msg);
            retVal = true;
        } else {
            disconnect(false);
            throw new OWException("Error checking Presence.",path, msg[OWNET_PROT_RETVALUE]);
        }
     ...
     * @throws java.io.IOException Exception to throw, when something is wrong
     */
    private String[] OW_Dir(String path, boolean dirall) throws IOException, OWException
    {
        ...
        do{
            ...
            if (msg[OWNET_PROT_RETVALUE] >= 0){
               ...
               disconnect(false);
               throw new OWException("Error getting Directory.", path,  msg[OWNET_PROT_RETVALUE]);
            }
...
//
     ...
     * @return attribute's value
     */
    public String Read(String path) throws IOException, OWException{
        return OW_Read(path);
    }
     ...
     * @throws java.io.IOException Exception to throw, when something is wrong
     */
    public boolean Write(String path, String value) throws IOException, OWException {
     ...
     * @return presence
     */
    public boolean Presence(String path) throws IOException, OWException {
     ...
     */
    public String[] Dir(String path) throws IOException, OWException {
     ...
     * @return array of elements found
     */
    public String[] DirAll(String path) throws IOException, OWException {
